...
- **Story (#FFC10)**: The feature or user story being explored
...
2. **Test List** (`/test-list`) converts those examples into `@Disabled("todo")` test cases
...
- Use the question tool to present specific options when you need clarification
...
- Use the question tool to resolve questions in real time
...
### How to Ask
- Use the **question tool** for structured questions with options
- Use **plain text questions** for open-ended exploration
- **Batch related questions** (up to 4) in a single question tool call
